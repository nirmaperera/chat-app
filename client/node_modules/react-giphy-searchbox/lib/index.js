...
var _poweredByGiphy = require('./assets/poweredByGiphy.png');
...
var ReactGiphySearchBox = function ReactGiphySearchBox(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    {
      className: '' + _indexModule2.default.componentWrapper + (wrapperClassName ? ' ' + wrapperClassName : ''),
    ...
    _react2.default.createElement(
      'div',
      {
        className: '' + _indexModule2.default.listWrapper + (listWrapperClassName ? ' ' + listWrapperClassName : ''),
...
ReactGiphySearchBox.defaultProps = {
  ...
  loadingImage: _spinner2.default,
  ...
  poweredByGiphy: true,
  poweredByGiphyImage: _poweredByGiphy2.default,
  rating: 'g',
  searchFormClassName: '',
  wrapperClassName: '',
